...
unverzweigte Aktivität darstellt, ist unten dargestellt.

![UML Aktivitätsdiagramm - Simple Start Stop](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/01_aktion_start_stop.svg?sanitize=true)
...
Quelltext. https://www.plantuml.com/plantuml/proxy?fmt=svg&src=https://www.quelltext.url/source.plantuml

Diagramm: [http://www.plantuml.com/plantuml/proxy?fmt=svg&src=https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/01_aktion_start_stop.plantuml](http://www.plantuml.com/plantuml/proxy?fmt=svg&src=https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/01_aktion_start_stop.plantuml)

Quelltext:
[https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/01_aktion_start_stop.plantuml](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/01_aktion_start_stop.plantuml)
...
![Verzweigungen mit einfacher Bedingung im UML Aktivitätsdiagramm](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/03_einfacheBedingung.svg?sanitize=true)
...
![Verzweigungen mit einfacher Bedingung im UML Aktivitätsdiagramm](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/03_einfacheVerzweigung.svg?sanitize=true)
...
![Komplexere Verzweigungen im UML Aktivitätsdiagramm](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/03_komplexereVerzweigung.svg?sanitize=true)
...
![Mehrfache Verzweigungen im UML Aktivitätsdiagramm](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/03_mehrfacheVerzweigung.svg?sanitize=true)
``` {style="plantuml"}
if() then ([Taste A])
    :Bewegung nach links;
elseif() then ([Taste D])
...
![Fussgesteuerte Schleifen im UML Aktivitätsdiagramm](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/04_fussgesteuerteSchleife.svg?sanitize=true)
``` {style="plantuml"}
start
repeat
    :Stufe hochsteigen;
...
![Kopfgesteuerte Schleifen im UML Aktivitätsdiagramm](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/04_kopfgesteuerteSchleife.svg?sanitize=true)
...
![](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/05_concurrency.svg?sanitize=true)
``` {style="plantuml"}
start
fork
    :Mache dies;
...
![](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/06_swimlanes.svg?sanitize=true)
...
![](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/07_signals.svg?sanitize=true)
...
![](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/08_ablaufende.svg?sanitize=true)
...
![](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/09_sprungmarken.svg?sanitize=true)
...
![](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/10_vornachbedingung.svg?sanitize=true)
...
![](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/11_aufhuebschen01.png)
...
@enduml
```  
![](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/11_aufhuebschen02.png)
...
@enduml
```  
![](https://raw.githubusercontent.com/hannsens/plantUML-Activity-Infosheet/master/plantuml/11_aufhuebschen03.png)
